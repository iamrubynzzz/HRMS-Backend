        ...
        http
                ...
                .authorizeHttpRequests(request -> request
                      ...
                      //  .requestMatchers("/ws").permitAll()
                        ...
                        .requestMatchers("/api/companies/create").hasAuthority(Role.SUPER_ADMIN.name())
                        .requestMatchers("/api/companies/update/**").hasAuthority(Role.SUPER_ADMIN.name())
                        .requestMatchers("/api/companies/delete/**").hasAuthority(Role.SUPER_ADMIN.name())
